...
class sampleSql extends Script
{
    /**
...
//    public $placeMarker='%';
    ...
    public function getModel()
    {
        return (new FfcModel())
            ...
            ->addFilenames('sampleSql.csv', 'sampleSql.xml') //Input file, Output file.
            ...
            ->addStatement(<<<XML
                INSERT INTO `sample_table` (`name`,`country`,`language`,`territory`,`created_at`,`updated_at`,`locale`) VALUES (
                    '~name~','~locale~','~language~','~upper:locale~','~iso8601:created_at~','~datetime~','~enLocale~'
                );
                XML)
